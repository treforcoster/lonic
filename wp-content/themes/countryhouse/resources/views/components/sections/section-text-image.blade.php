...
<section id="<?php //echo $section['section_id'];
              ?>" class="section section-line section-text-image marker-title-h2 image-<?php echo $position; ?> p-t-mobile-section p-t-desktop-section
  ...
  <div class="container-fluid">
    <div class="row <?php echo $justify; ?> <?php echo $order; ?>">
      <div class="<?php echo $textCol; ?> medium text-dark p-b-mobile-intro p-b-mobile-intro">
        <div class="marker-bottom p-b-desktop-intro">
