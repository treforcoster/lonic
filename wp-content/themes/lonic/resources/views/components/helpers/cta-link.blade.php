<?php $link = get_sub_field('link_text'); ?>
<?php $link_type = get_sub_field('type'); ?>
...
<div class="links d-flex gap-4">
    <a class="arrow-link d-flex" href="<?php echo $link;?>" target="<?php echo $target;?>"><?php the_sub_field('link_text')?>
