<?php $show_gallery = get_field('show_gallery'); ?>

<?php if ($show_gallery === "yes") { ?>

  <section id="<?php //echo $section['section_id'];
                ?>" class="section section-property-single-carousel">
            ...
            <div class="swiper-wrapper">
              <?php foreach ($images as $image) : ?>
                ...
                <div class="swiper-slide">
                  ...
                  <?php if ($imgmeta['width'] > $imgmeta['height']) { ?>
                  ...
                  <?php } else { ?>
                    ...
                    <div class="image-portrait">
                      <img src="<?php echo esc_url($image['sizes']['gallery-image-portrait']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
                    </div>
