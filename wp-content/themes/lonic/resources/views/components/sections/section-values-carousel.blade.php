<section id="<?php //echo $section['section_id'];
              ?>" class="section section-line section-values-carousel marker-title-h2-lead-in bg-colour-dark  ">
  ...
  <div class="content p-t-mobile-section p-b-mobile-90px p-t-desktop-section p-b-desktop-section  ">
    <div class="values-wrapper">
      <div class="container-fluid">
        ...
        <div class="row p-b-mobile-element p-t-desktop-section">

          <div class="swiper-container values-swiper">
                  ...
                  <div class="swiper-slide">
                    <div class="inner">
                      ...
                      <div class="text text-black medium">
                        <div class="serif"><?php echo $count; ?>.</div>
